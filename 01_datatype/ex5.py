...
print("Java" in s)                  # 미포함(False) - not 붙이면 반대의 결과를 뽑을 수 있음 - 예) print("Java" not in s)    
...
# print("123".isnumeric())              # 숫자이면 True -> 애는 로마 숫자 및 여러 가지의 숫자를 인식할 수 있음(예: 중국어,동그라미 안의 숫자 등등)
