...
d = {"id": 1317, "name": "이루원", "age": 17}
print(d)

# 키로 값 가져오기
print(d["name"])
# print(d["phone"])                   # error 발생
...
d["phone"] = "123-4567"             # 이러면 새로운 키가 추가됨
print(d)

del d["phone"]                      # 이러면 원하는 키를 삭제할 수 있음
print(d)
...
d[(1, 2)] = 100         # 리스트는 키로 못 씀
print(d)

# 키로 가능한 것 : immutable 타입 (숫자형, 불리언, 문자열, 튜플) -> hashable type  -> 변경 가능한 것들
# 키로 안되는 것 : mutable 타입 (리스트, 딕셔너리, 집합) -> unhashable type        -> 변경 불가능한 것들
# 키는 해시 가능(hashable) + 프로그램 실행 동안 hash값이 변하지 않아야 함

print(hash(12345))              # 이건 할 때마다 바뀌지만 한번 출력될 때는 같아야 함
print(hash("python"))
print(hash((1, 2)))
...
# 딕셔너리 합치기
d2 = {"sci": 95, "prog": 100}
# print(d + d2)     # +를 사용할 수 없음

# 딕셔너리 반복하기
# print(d * 2)      # *도 사용할 수 없음
